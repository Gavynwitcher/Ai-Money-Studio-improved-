      ...
      <section className="page-section pt-0">
        <Container>
          <Card className="rounded-[32px] space-y-6 text-sm leading-7 text-[var(--muted)]">
            <p>
              Unified Banking Hub may collect account connection metadata, profile information, product usage events, and waitlist or contact form submissions needed to operate the platform and improve the service.
            </p>
            <p>
