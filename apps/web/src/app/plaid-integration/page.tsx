  ...
  return (
    <>
      <PageHero
        ...
        title="A polished mock flow with clear Plaid handoff points."
        description="The UI is already shaped around the API lifecycle needed for a real Plaid integration: link token creation, public token exchange, item storage, account fetches, balance visibility, transactions sync, and transfer initiation."
        primaryCta={{ href: "#plaid-demo", label: "Launch mock connect flow" }}
