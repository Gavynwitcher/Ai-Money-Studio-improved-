...
export function PageHero({
  ...
  return (
    <section className="page-section pt-16 sm:pt-20">
      <Container>
        <div className="bank-shell grid-fade relative overflow-hidden rounded-[34px] px-6 py-12 sm:px-10 lg:px-12">
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            ...
            <div className="grid gap-3">
              <div className="bank-stat-dark rounded-[24px] p-4 text-white">
